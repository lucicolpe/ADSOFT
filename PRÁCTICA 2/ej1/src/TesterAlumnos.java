...
import eps.uam.ads.p2.autoescuela.ej1.Alumno; 
/**
* Tester el primer apartado de la P2
* @author Profesores ADS
*/ 
public class TesterAlumnos {public static void main(String[] args) { 
             Alumno a1= new Alumno(12345678, "Pedro", "García Gómez", "C/ Delicias 34", 644444243, 10, 2, 2016); 
             ...
             System.out.println("isValida <"+ a2.getFechaMatricula().getFecha() + "> ? "+ a2.isFechaValida(a2.getFechaMatricula())); 
