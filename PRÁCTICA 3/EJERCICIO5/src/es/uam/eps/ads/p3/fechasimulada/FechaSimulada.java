...
/**
 * Clase auxiliar para permitir pruebas de la Practica 3 con "fechas simuladas" y controladas
...
public class FechaSimulada {
	...
	/**
	 * Se fija la fecha simulada con los valores de dia, mes y anio dados como parametros
	 * @param dia
	 * @param mes
	 * @param anyo
